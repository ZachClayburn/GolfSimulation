...
RPrime(2) = R(5) + R(8);
RPrime(3) = R(6) + R(9);
RPrime(4) = -dragNum*R(4)*abs(R(4)) + mangusNum*(R(11)*R(12) - R(12)*R(11));
RPrime(5) = -g - dragNum*R(5)*abs(R(5)) + mangusNum*(R(12)*R(10) - R(10)*R(12));
RPrime(6) = -dragNum*R(6)*abs(R(6)) + mangusNum*(R(10)*R(11) - R(11)*R(10));
RPrime(7) = 0;
RPrime(8) = 0;
RPrime(9) = 0;
RPrime(10) = 0;
